	...
	return (
		<div className="w-full">
			<div className="flex items-start justify-start space-x-3">
				{apps.length > 0 ? (
					apps.map(app => (
						<div key={app.id} className="w-[72px] h-[72px] relative flex flex-col justify-center place-content-center bg-white/20 backdrop-blur hover:bg-white/30 rounded-xl">
					...
					<>
						<Skeleton className="w-[72px] h-[72px] bg-white/20 animate-pulse" />
						<Skeleton className="w-[72px] h-[72px] bg-white/20 animate-pulse" />
						<Skeleton className="w-[72px] h-[72px] bg-white/20 animate-pulse" />
						<Skeleton className="w-[72px] h-[72px] bg-white/20 animate-pulse" />
						<Skeleton className="w-[72px] h-[72px] bg-white/20 animate-pulse" />
				...
				<Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
					<DialogTrigger className="w-[72px] h-[72px] flex flex-col justify-center place-content-center items-center bg-white/20 hover:bg-white/30 rounded-lg">
